...
<!-- //For-Mobile-Apps-and-Meta-Tags -->
<!-- Custom Theme files -->
<link href="{{asset('Styles/css/bootstrap.css')}}" type="text/css" rel="stylesheet" media="all">
<link href="{{asset('Styles/css/style.css')}}" type="text/css" rel="stylesheet" media="all"> 
<link rel="stylesheet" href="{{asset('Styles/css/ken-burns.css')}}" type="text/css" media="all" /> 
<!-- //Custom Theme files -->
<!-- js -->
<script src="{{asset('Styles/js/jquery-2.2.3.min.js')}}"></script> 
<!-- //js -->
<!-- pop-up-box -->
<script src="{{asset('Styles/js/jquery.magnific-popup.js')}}" type="text/javascript"></script>
	    <script>
...
<body class="bg">
				...
				<div class="w3agile properties">
					...
					<div class="properties-bottom">
						<div class="properties-img">
							<img src="{{asset('Styles/images/3.jpg')}}" alt="">
					...
					<div class="properties-bottom">
						<div class="properties-img">
							<img src="{{asset('Styles/images/2.jpg')}}" alt="">
					...
					<div class="properties-bottom">
						<div class="properties-img">
							<img src="{{asset('Styles/images/1.jpg')}}" alt="">
							<div class="view-caption">
				...
				<div class="w3agile brands"> 
					...
					<div class="brands-info">
						<div class="brand-grids">
							<a href="#"><img src="{{('Styles/images/b1.jpg')}}" alt=""/></a>
						</div>
						<div class="brand-grids">
							<a href="#"><img src="{{('Styles/images/b2.jpg')}}" alt=""/></a>
						</div>
						<div class="brand-grids">
							<a href="#"><img src="{{('Styles/images/b3.jpg')}}" alt=""/></a>
						</div>
						<div class="brand-grids">
							<a href="#"><img src="{{('Styles/images/b4.jpg')}}" alt=""/></a>
						</div>
						<div class="brand-grids">
							<a href="#"><img src="{{('Styles/images/b5.jpg')}}" alt=""/></a>
						</div>
						<div class="brand-grids">
							<a href="#"><img src="{{('Styles/images/b6.jpg')}}" alt=""/></a>
						</div>
						<div class="clearfix"> </div>
					</div>
				</div>
	...
	<!-- //menu-js -->
	<!-- nice scroll-js -->
	<script src="{{asset('Styles/js/jquery.nicescroll.min.js')}}"></script> 
	<script>
		$(document).ready(function() {
